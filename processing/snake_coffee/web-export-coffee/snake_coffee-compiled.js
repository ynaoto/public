var SketchSnakecoffee;

SketchSnakecoffee = (function() {
  ...
  SketchSnakecoffee.name = 'SketchSnakecoffee';

  function SketchSnakecoffee() {}
  ...
  Bar = (function() {
    ...
    Bar.prototype.getEndPoint = function() {
      return [this.l * cos(this.r) + this.cx, this.l * sin(this.r) + this.cy];
    };

    Bar.prototype.draw = function() {
      var ex, ey, _ref;
      _ref = this.getEndPoint(), ex = _ref[0], ey = _ref[1];
      line(this.cx, this.cy, ex, ey);
      return [ex, ey];
    };
